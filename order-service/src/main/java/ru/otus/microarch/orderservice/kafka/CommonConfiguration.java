package ru.otus.microarch.orderservice.kafka;
...
public class CommonConfiguration {
    ...
    public NewTopic createOrderTopic() {
        return new NewTopic(CREATE_ORDER_KAFKA_TOPIC_NAME, 1, (short) 1);
    }

    @Bean
    public NewTopic cancelOrderTopic() {
        return new NewTopic(CANCEL_ORDER_KAFKA_TOPIC_NAME, 1, (short) 1);
    }
}
